 ...
 */
export default function ItemModal({ t, addedName, context, onAdd, onContinue, onViewCart }) {
  return (
    <div className="fixed inset-0 z-30 bg-black/40 flex items-end justify-center">
      <div className="w-full max-w-[480px] bg-white rounded-t-2xl p-4 animate-[slideUp_.2s_ease-out]">
        ...
        <RecoStrip slot="item_added" context={context} title={t("goesWellWith")} t={t} onAdd={onAdd} limit={3} />
